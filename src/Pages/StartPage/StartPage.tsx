  ...
  return (
    <div>
            <section className="bg-green-500 text-white h-64 flex flex-col justify-center items-center">
                <h1 className="text-3xl md:text-5xl text-center font-bold mb-4">Follow the latest football transfers!</h1>
                <p className="text-lg md:text-xl text-center mb-6">Stay updated with the latest news from the world of football.</p>
                <Link to="/register">
            ...
            <section className="py-16 px-4 md:px-16">
                <h2 className="text-2xl md:text-4xl font-bold text-center mb-8">About PitchSwitch</h2>
